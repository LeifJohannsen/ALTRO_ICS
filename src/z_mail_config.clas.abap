CLASS Z_MAIL_CONFIG DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS Z_MAIL_CONFIG IMPLEMENTATION.
...
*    set_configuration( out ).
  ...
  METHOD set_configuration.
    ...
    TRY.
        DATA(lt_allowed_receiver) = VALUE cl_bcs_mail_system_config=>tyt_recipient_domains( ( '*@GMAIL.com' )
                                                                                            ( '*@CENTRIC.eu' ) ).
    ...
    TRY.
        DATA(lt_allowed_sender) = VALUE cl_bcs_mail_system_config=>tyt_sender_domains( ( '*@GMAIL.com' ) ).
    ...
    TRY.
        lo_config->modify_default_sender_address( iv_default_address = 'Leifjellejohannsen@gmail.com'
                                                  iv_default_name    = '' ).
